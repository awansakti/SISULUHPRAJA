        ...
        <div class="md:flex md:shrink-0 ">
          ...
          <div class="bg-white w-full p-4 md:py-2 md:pr-12 md:pl-8 text-sm flex justify-first items-center top_bar">
              <div class="placement-top-left">
                  <div class="mt-1 welcome_text">Selamat Pagi <span>{{ $page.props.auth.user.first_name }}!</span></div>
                  ...
                  <dropdown class="mt-1 select_user" placement="bottom-end">
                      ...
                      <template #dropdown>
                          <div class="shadow-xl bg-white rounded text-sm">
                              <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white" :href="route('users.edit.profile')">{{ __('Ubah Profil') }}</Link>
                              <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white w-full text-left" :href="route('logout')" method="delete" as="button">{{ __('Keluar') }}</Link>
                          </div>
                      </template>
                  </dropdown>
              </div>
